 ...
 */
export async function buildOragerSkillsDir(desiredSkills) {
    ...
    for (const entry of available) {
        if (desiredSet !== null && !desiredSet.has(entry.name.toLowerCase()))
            continue;
 ...
 */
export async function cleanupOragerSkillsDir(dir) {
