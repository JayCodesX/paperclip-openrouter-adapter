...
// Assembles the final AdapterExecutionResult from a parsed "result" event.
...
export async function executeAgentLoop(
  ...
  //
  // NB: buildConfigFilePayload is a closure over the variables extracted above.
  // Keeping it as a named local function means adding a new field only requires
  // one change per path, and
